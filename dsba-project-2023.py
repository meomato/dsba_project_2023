...
st.markdown("As we can see, 1 line of our table was printed, in which all names were changed according to snake_case: capital letters were replaced by small letters, and spaces - by underscores")
